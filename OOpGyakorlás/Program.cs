...
namespace OOpGyakorlás
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			Kemek kem = new Kemek("Oroszlan", "magyarorszag",6,80);
            Console.WriteLine(kem);
			kem.SikerEsejNovelese(10); // itt növeltem az esélyét
            Console.WriteLine(" A kém Talált valami hasznosat így nőtt az esélye");
			Console.WriteLine(kem);
            Console.WriteLine("--------------------------------------------------------------");
			Kemek orosz = new Kemek("VorosHollo", "Oroszorszag");
            Console.WriteLine(orosz);
			orosz.KuldetesInditasa();
			orosz.VeszelySzintNovelese(10);
			Console.WriteLine(orosz);
        }
	}
}
