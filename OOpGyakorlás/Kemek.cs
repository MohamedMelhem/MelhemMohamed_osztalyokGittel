...
namespace OOpGyakorlás
{
    internal class Kemek
    {
        ...
        public Kemek(string kodnev, string orszag, int veszelySzint, int sikerEsej)
        {
            this.kodnev = kodnev;
            this.orszag = orszag;
        ...
        public Kemek(string kodnev, string orszag)
        {
            this.kodnev = kodnev;
            this.orszag = orszag;
            veszelySzint = 5;
        ...
        {
            return $"{this.Kodnev} {this.orszag}nak dolgozik {this.VeszelySzint} Szinten Veszélyes. És {this.SikerEsej}% az esléye";
        }
    }
}
